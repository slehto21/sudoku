...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (newGameButton) newGameButton!.addEventListener('click', chooseDifficultyModal);
    if (modalEasyButton) modalEasyButton.addEventListener('click', () => handleGenerateSudoku("Easy"));
    if (modalMediumButton) modalMediumButton.addEventListener('click', () => handleGenerateSudoku("Medium"));
    if (modalHardButton) modalHardButton.addEventListener('click', () => handleGenerateSudoku("Hard"));
});
